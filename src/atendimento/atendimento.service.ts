...
@Injectable()
export class AtendimentoService implements ICrudService<Atendimento,AtendimentoDto>{
    constructor(@InjectModel(Atendimento.name) private model: Model<AtendimentoDocument>
    ){
        this.model = model;
    }
